    ...
    public int read(byte[] buffer, int offset, int count) throws IOException {
        ...
        if (flag < 0) {
            switch (flag) {
                ...
                default:
                    throw new IOException("Error reading jpegstream.jpeg stream");
            }
        }
        return flag;
    }
    ...
    public long skip(long byteCount) throws IOException {
        ...
        if (flag < 0) {
            switch (flag) {
                ...
                default:
                    throw new IOException("Error skipping jpegstream.jpeg stream");
            }
        }
        return flag;
    }
    ...
    private void applyConfigChange() throws IOException {
        if (mConfigChanged) {
            ...
            switch(flag) {
                ...
                default:
                    throw new IOException("Error to reading jpegstream.jpeg headers.");
            }
            mWidth = dimens.x;
            mHeight = dimens.y;
