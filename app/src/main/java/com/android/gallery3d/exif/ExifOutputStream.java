 ...
 *
 * <pre>
 * public static void writeExif(byte[] jpegstream.jpeg, ExifData exif, String path) {
 ...
 *         // Write the original jpegstream.jpeg out, the header will be add into the file.
 *         eos.write(jpegstream.jpeg);
            ...
            switch (mState) {
                case STATE_SOI:
                    ...
                    if (mBuffer.getShort() != JpegHeader.SOI) {
                        throw new IOException("Not a valid jpegstream.jpeg image, cannot write exif");
                    }
