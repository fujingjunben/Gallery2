...
// Initializes the DestManager struct, sets up the cpp refs
int32_t MakeDst(j_compress_ptr cinfo, JNIEnv *env, jobject outStream);

/**
 * Updates the cpp env pointer. This should be called in the beginning of any
...
// Cleans the cpp refs.  To wipe the compress object call jpeg_destroy_compress
...
// Initializes the SourceManager struct, sets up the cpp refs
...
// Cleans the cpp refs.  To wipe the decompress object, call jpeg_destroy_decompress
